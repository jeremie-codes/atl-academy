        ...
        <div class="row no-gutters d-flex">
            <div class="col-lg-4 d-flex align-self-stretch ftco-animate">
                <div class="media block-6 services d-flex">
                    ...
                    <div class="media-body pl-4">
                        <h3 class="heading mb-3">Excellence professionnelle</h3>
            ...
            <div class="col-lg-4 d-flex align-self-stretch ftco-animate">
                <div class="media block-6 services services-2 d-flex">
                    ...
                    <div class="media-body pl-4">
                        <h3 class="heading mb-3">Innovation et pratique</h3>
                        <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 d-flex align-self-stretch ftco-animate">
                <div class="media block-6 services d-flex">
                    ...
                    <div class="media-body pl-4">
                        <h3 class="heading mb-3">Employabilité et impact</h3>
                        <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="carousel-testimony owl-carousel ftco-owl">
                    ...
                    <div class="item">
                        <div class="testimony-wrap py-4 pb-5 d-flex justify-content-between align-items-end">
                            ...
                            <div class="text">
                                <p class="mb-4">
                                    Les cours sont clairs, bien structurés et orientés vers les réalités
                                    du terrain africain. Je recommande fortement cette académie.
                                </p>
                                <p class="name">Sarah L.</p>
                                <span class="position">Apprenante</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item">
                        <div class="testimony-wrap py-4 pb-5 d-flex justify-content-between align-items-end">
                            ...
                            <div class="text">
                                <p class="mb-4">
                                    Une formation complète qui couvre aussi bien la logistique,
                                    le transport que la supply chain. Un excellent investissement
                                    pour l’avenir professionnel.
                                </p>
                                <p class="name">Michael T.</p>
                                <span class="position">Ancien apprenant</span>
                            </div>
                        </div>
                    </div>
